...
export const TOWERS: Record<TowerTier, UnitDef> = {
  outer: {
    ...
    radius: 1.3,
    shape: 'tower',
    base: statBlock({ maxHp: 7000, ad: 450, armor: 150, mr: 150, range: 8 }),
  ...
  inner: {
    ...
    radius: 1.3,
    shape: 'tower',
    base: statBlock({ maxHp: 8000, ad: 500, armor: 170, mr: 170, range: 8 }),
    attack: { interval: 1.0, windupRatio: 0.25, projectile: { speed: 20, vfx: { color: 0xffffff, style: 'bolt', size: 0.2 } } },
    gold: 150,
    xp: 180,
  },
  high: {
    ...
    radius: 1.4,
    shape: 'tower',
    base: statBlock({ maxHp: 9000, ad: 560, armor: 190, mr: 190, range: 8 }),
...
export const CRYSTAL: UnitDef = {
  ...
  radius: 2.2,
  shape: 'crystal',
  base: statBlock({ maxHp: 12000, ad: 650, armor: 200, mr: 200, range: 8.5, hpRegen: 0 }),
